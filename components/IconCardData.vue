<template>
  ...
  :class="{ 'hover-bg': showButtons }"
    ...
    <div v-show="showButtons" class="ext-buttons">
      <div style="top: 12px; right: 12px" class="position-absolute">
        <svg
          width="36"
          height="36"
          viewBox="0 0 36 36"
      ...
      <div style="bottom: 12px; right: 12px" class="position-absolute">
        <svg
          width="36"
          height="36"
          viewBox="0 0 36 36"
...
export default defineComponent({
  ...
  computed: {
    // drawCanvas() {
    //   const c = this.$refs.iconCanvas as HTMLCanvasElement;
    //   const ctx = c.getContext("2d");
    //   const base_image = new Image();
    //   base_image.src = this.data.urls.thumb;
    //   base_image.onload = () => {
